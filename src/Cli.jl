...
function parse_commandline(cmd_args)
    ...
    @add_arg_table s begin
        ...
        "--robustness-delta"
            ...
            arg_type    =   Float64
            default     =   -Inf64
        "--robustness-delta-symmetric"
            help        =   "Verify confidence based robustness with given delta and symmetric confidence"
            arg_type    =   Float64
            default     =   -Inf64
        "--robustness-delta-symmetric-N2"
...
function run_cmd(args)
    ...
    if robustness_delta_symmetric != -Inf64
        ...
        property = get_top1_both_confident_property(delta1=delta1, delta2=delta2, naive=parsed_args["naive"])
